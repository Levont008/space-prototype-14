...
using Content.Client.ScavPrototype.NewMedical.UserInterface.Targeting.Widgets;
...
namespace Content.Client.ScavPrototype.NewMedical.UserInterface.Targeting;
